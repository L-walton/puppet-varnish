...
This module Supports Varnish versions 3.0, 4.0, 4.1, 5.0, 5.1, 5.2, 6.0,
and 6.1 across Ubuntu 14.04/16.04, Debian 7/8 and RedHat derivates 6/7.
...
* Varnish 5.x, and 6.x supports **only** Debian 8 and Ubuntu 16.04
